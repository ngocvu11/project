                                  ...
                                  <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Chi tiết đơn hàng đang chờ</h4>
                                          </div>
                                          ...
                                          <div class="modal-footer" style="clear: both">
                                              <a href="{{ URL::route('admin.bill.getTthoanthanh',$items['id']) }}" class="btn btn-success">Thành công</a>
