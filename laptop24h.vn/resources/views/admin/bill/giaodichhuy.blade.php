         ...
         @foreach($datahuy as $items)
          <tr class="">
           ...
           <td style="text-align:center;">
            ...
            <a href="{{ URL::route('admin.bill.getRestore',$items['id']) }}" class="btn btn-default btn-xs fa fa-mail-reply-all"></a>
          </td>
          <!-- Modal -->
                                  ...
                                  <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Chi tiết đơn hàng đã hoàn thành</h4>
                                          </div>
                                          <div class="modal-body">
                                              ...
                                              <div class="totalct" style="clear: both;margin: 3em">
                                                <h4 style="color: red;text-align: right">
